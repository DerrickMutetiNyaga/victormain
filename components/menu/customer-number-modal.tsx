      ...
      >
        ...
        <div className="p-6">
          <DialogHeader className="mb-5">
            <div className="h-12 w-12 rounded-2xl bg-[#382C21] border border-[rgba(242,232,216,0.14)] flex items-center justify-center mb-4 shadow-[0_0_24px_rgba(200,114,42,0.18)]">
              <Phone className="h-6 w-6 text-[#D9843B]" />
            </div>
            <p className="text-[10px] font-semibold tracking-[0.22em] uppercase text-[#D9843B] mb-2 text-left">
              Welcome
            </p>
            <DialogTitle className="text-xl font-semibold text-[#F5EBDC] text-left font-[family-name:var(--menu-font-display)]">
              Your table awaits
            </DialogTitle>
            <DialogDescription className="text-[rgba(242,232,216,0.65)] text-sm text-left mt-1.5">
          ...
          <div className="space-y-3">
            <input
              ...
              className="h-11 w-full rounded-xl border border-[rgba(242,232,216,0.14)] bg-[#382C21] px-3 text-sm text-[#F5EBDC] placeholder:text-[rgba(242,232,216,0.45)] outline-none focus:border-[rgba(200,114,42,0.55)] focus:ring-2 focus:ring-[rgba(200,114,42,0.12)] transition-all duration-500"
            />
