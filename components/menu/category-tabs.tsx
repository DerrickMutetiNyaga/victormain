    ...
    <div className="pb-3">
      ...
      <div className="relative">
        ...
        >
          ...
          {hasJaba && (
            <>
              <button
                type="button"
                onClick={onJabaClick}
                className="inline-flex items-center gap-1.5 py-2 px-3.5 rounded-full text-[13px] font-semibold shrink-0 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] snap-start"
                style={{
          ...
          {/* Category pills — cleaner for quick menu scanning */}
          {allCategories.map((cat) => {
            ...
            return (
              <button
                ...
                className="flex items-center py-2 px-3.5 rounded-full text-[13px] font-semibold whitespace-nowrap flex-shrink-0 transition-all duration-200 active:scale-[0.97] snap-start"
                style={{
                  ...(isActive
                    ? {
                        ...
                        color: "#0c0a09",
                        border: "none",
                        boxShadow: "0 2px 10px rgba(245,158,11,0.32), 0 1px 0 rgba(255,255,255,0.18) inset",
                      }
                    : {
