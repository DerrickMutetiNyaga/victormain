        ...
        <div className="flex items-start sm:items-center justify-between gap-4 py-4 sm:py-5">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 h-5 min-w-[20px] px-1 rounded-full bg-[#1F8A3B] text-[#FFFFFF] text-[11px] font-semibold flex items-center justify-center">
