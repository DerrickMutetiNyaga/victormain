        ...
        <head>
          ...
          <style>
            ...
            * {
            ...
            .payment-glovo { background: #fff7ed; color: #9a3412; }
                ...
                <div class="meta-row">
                  ...
                  <span class="payment-badge ${
                    order.paymentMethod?.toLowerCase() === "cash"
                      ...
                      ? "payment-mpesa"
                      : order.paymentMethod?.toLowerCase() === "glovo"
                      ? "payment-glovo"
                      : "payment-card"
                  }">${order.paymentMethod || "—"}</span>
                </div>
                ${
                  order.paymentMethod?.toLowerCase() === "glovo" && order.glovoOrderNumber
                    ? `<div class="meta-row">
                        <span class="meta-label">Glovo Order #</span>
                        <span class="mpesa-code">${order.glovoOrderNumber}</span>
                      </div>`
                    : ""
                }
                ${
