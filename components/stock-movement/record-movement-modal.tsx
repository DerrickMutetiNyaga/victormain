  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="w-full gap-2 rounded-xl bg-primary hover:bg-primary/90 shadow-sm sm:w-auto">
      ...
      <DialogContent className="max-h-[90vh] w-[calc(100vw-1.5rem)] max-w-2xl overflow-y-auto">
        ...
        <div className="flex flex-col-reverse gap-3 border-t pt-4 sm:flex-row sm:justify-end">
          <Button variant="outline" onClick={() => setOpen(false)} className="w-full rounded-lg sm:w-auto">
            Cancel
          </Button>
          <Button onClick={handleSubmit} className="w-full rounded-lg bg-primary hover:bg-primary/90 sm:w-auto" disabled={!type || !reason || !productId || !quantity || isLoading}>
            {isLoading ? (
              <>
