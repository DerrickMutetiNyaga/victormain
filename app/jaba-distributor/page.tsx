...
export default function JabaDistributorPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F0FDF4] via-[#ECFDF5] to-[#F0FDF4]">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-[120px] md:pb-8">
            ...
            <div className="rounded-2xl border-2 border-[#10B981]/20 bg-white/90 backdrop-blur-sm p-6 shadow-lg">
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  className="mt-0.5 size-5 border-[#9fb3ab] bg-white data-[state=checked]:bg-[var(--brand-green)] data-[state=checked]:border-[var(--brand-green)] data-[state=checked]:text-white shadow-sm"
                />
                <label
                  htmlFor="terms"
