...
import { safeCathaCallbackUrl } from '@/lib/auth-callback-url'
...
export default async function CathaLoginPage({
  ...
  /** Never pass raw query to OAuth — sanitize on server. */
  const callbackUrl = safeCathaCallbackUrl(params.callbackUrl ?? '/catha/entry')
